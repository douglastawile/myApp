...
function validateCourse(subject) {
  if (!subject.title) return "Title is required.";
  if (!subject.classScore) return "Class Score is required.";
  if (!subject.examScore) return "Exams Score is required.";
  if (!subject.total) return "Total Score is required.";
  if (!subject.grade) return "Grade is required.";
  if (!subject.remark) return "Remark is required.";
  return "";
}
